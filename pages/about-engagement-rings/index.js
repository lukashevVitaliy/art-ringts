...
import s from "./about-engagement-rings.module.scss";


const AboutEngagementRings = () => {
	return (
		<div className={s.about_engagement_rings}>
			<Head>
				<title>About Engagement Rings</title>
			</Head>
			<div className="container">
				<div className={s.about_engagement_rings_wrap}>
					<div className={s.about_engagement_rings_left}>
						<h3 className={s.about_engagement_rings_title}>КАК ВЫБРАТЬ ОБРУЧАЛЬНЫЕ КОЛЬЦА?</h3>
						<div className={s.about_engagement_rings_desc}>
							<p>
							...
							<p>
								Сказать любимой о силе своих чувств и серьёзности намерений можно, подарив ей помолвочное кольцо.
							</p>
							<p>
...
export default AboutEngagementRings